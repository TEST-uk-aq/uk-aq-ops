...
export UK_AQ_LOCAL_AQI_V2_SOURCE_ROOT="${UK_AQ_LOCAL_AQI_V2_SOURCE_ROOT:-/Users/mikehinford/Dropbox/Apps/github-uk-air-quality-networks/TEST/R2_history_backup}"
