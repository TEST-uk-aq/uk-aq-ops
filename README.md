...
- `UK_AQ_R2_HISTORY_MAX_SECONDS_PER_RUN` (default `1740`; Phase B internal maximum)
- `UK_AQ_R2_HISTORY_STOP_BEFORE_TIMEOUT_SECONDS` (default `60`; gives a 1680-second effective Phase B deadline)
