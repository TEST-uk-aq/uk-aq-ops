...
export function detectAreaTownColumns(rawHeaders) {
  return {
    ctry: chooseOptionalColumn(rawHeaders, ["ctry"]),
    buasd24: chooseOptionalColumn(rawHeaders, ["buasd24"]),
    bua24: chooseOptionalColumn(rawHeaders, ["bua24"]),
    parish: chooseOptionalColumn(rawHeaders, ["parish"]),
    osward: chooseOptionalColumn(rawHeaders, ["osward"]),
    oslaua: chooseOptionalColumn(rawHeaders, ["oslaua", "lad", "ladcd", "lad23cd", "lad24cd"]),
    ttwa: chooseOptionalColumn(rawHeaders, ["ttwa"]),
    oscty: chooseOptionalColumn(rawHeaders, ["oscty"]),
