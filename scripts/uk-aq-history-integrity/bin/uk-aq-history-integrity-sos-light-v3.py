...
The implementation lives in the sibling ``uk-aq-history-integrity-sos-light-v3_impl.py``
...
_IMPLEMENTATION_PATH = _WrapperPath(__file__).with_name("uk-aq-history-integrity-sos-light-v3_impl.py")
