...
Changes outside the WHO summary route must read the authoritative area contract for the affected subsystem, including `latest_snapshot/`, `r2_history/`, `aqi-levels/`, `station_charts/` or `geography/` where applicable.
